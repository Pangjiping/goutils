...
func (m *LinkedMap) Get(key interface{}) (interface{}, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *LinkedMap) Set(key, value interface{}) bool {
	m.mu.RLock()
...
func (m *LinkedMap) GetOrDefault(key, defaultValue interface{}) interface{} {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *LinkedMap) Front() *Element {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *LinkedMap) Copy() *LinkedMap {
	m2 := NewLinkedMap()
